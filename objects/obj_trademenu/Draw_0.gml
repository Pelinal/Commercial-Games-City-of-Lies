...
if overview_id != -1 {
	...
	if current_tab == "craft" {
		...
		draw_text(x+ 312, y+ 444, string(craft_amount))
	...
	if current_tab == "sell" {
		...
		if crafting_category != "enchanting" {
			...
			draw_text(x + 314, y + 288, string(inventory_fetch(overview_row[2])) + " / " + string(craft_amount*cc[1]))
			draw_text(x + 314, y + 400, string(inventory_fetch(overview_row[3])) + " / " + string(craft_amount*cc[2]))
			draw_set_halign(fa_left)
		}
		else if crafting_category == "enchanting" && ench_selected_items[1] == -1 && ench_selected_items[2] == -1 {
			draw_tile(ts_icons_iconset, global.icons[overview_row[1]], 0, x + 292, y + 128)
			draw_tile(ts_icons_iconset, global.icons[4], 0, x + 292, y + 248)
			...
			draw_set_font(fnt_textbox_10)
			draw_text(x + 312, y + 112, global.library[overview_row[1]][0])
			draw_text(x + 312, y + 232, "Click to Add")
			draw_text(x + 312, y + 352, "Click to Add")
			draw_set_font(fnt_inventory_12)
			draw_text(x + 314, y + 160, string(inventory_fetch(overview_row[1])) + " / " + string(craft_amount*cc[0]))
			//draw_text(x + 314, y + 288, string(inventory_fetch(ench_selected_items[0])) + " / " + string(craft_amount*cc[1]))
			//draw_text(x + 314, y + 400, string(inventory_fetch(overview_row[3])) + " / " + string(craft_amount*cc[2]))
			draw_set_halign(fa_left)
		}
		else if crafting_category == "enchanting" && ench_selected_items[1] != -1 && ench_selected_items[2] == -1 {
			...
			draw_text(x + 314, y + 160, string(inventory_fetch(overview_row[1])) + " / " + string(craft_amount*cc[0]))
			//draw_text(x + 314, y + 288, string(inventory_fetch(ench_selected_items[1])) + " / " + string(craft_amount*cc[1]))
			draw_text(x + 314, y + 400, string(inventory_fetch(ench_selected_items[2])) + " / " + string(craft_amount*cc[2]))
			draw_set_halign(fa_left)
		}
		else if crafting_category == "enchanting" && ench_selected_items[1] != -1 && ench_selected_items[2] != -1 {
			draw_tile(ts_icons_iconset, global.icons[overview_row[1]], 0, x + 292, y + 128)
		...
		if crafting_category == "alchemy" {
			...
			for (i = 0; i < array_length(global.ar_library); i ++) {
				if global.ar_library[i][0] == overview_id {
					...
					draw_text(x + 384, y + 288, "Slot: " + string(global.ar_library[i][4]))
					draw_text(x + 384, y + 320, "Armour: " + string(global.ar_library[i][2]) + " PTS")
					draw_text(x + 384, y + 352, "Craft Cost: " + string(overview_price) + " Gold")
				}
			}
			for (i = 0; i < array_length(global.w_library); i ++) {
				if global.w_library[i][0] == overview_id {
		...
		if crafting_category == "enchanting" {
			for (i = 0; i < array_length(global.m_library); i ++) {
				if global.m_library[i][0] == overview_id {
					draw_text(x + 384, y + 256, "Used For: " + global.m_library[i][1])
					draw_text(x + 384, y + 288, "Craft Cost: " + string(overview_price) + " Gold")		
				}
			}
		}
	}
